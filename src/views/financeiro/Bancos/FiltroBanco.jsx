...
const schema = yup.object({
   ban_is_ativo: yup.boolean().nullable()
});
...
const FiltroBanco = ({ open, handleDrawerOpen, filtro, handleFiltro }) => {
               ...
               <Box sx={{ p: 3 }}>
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                        <Grid container spacing={3}>
                           <Grid item xs={12}>
                              <Typography variant="h4">Filtrar Bancos</Typography>
                           </Grid>
                           <Grid item xs={12}>
                              <InputForm
                                 name="ban_nome"
