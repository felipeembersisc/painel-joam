...
const schema = yup.object({
   // ati_pesquisa: yup.string().required('Campo obrigatório'),
   ite_valor_unitario: yup.string().required('Campo obrigatório'),
...
const AddItensDocumento = ({ open, setOpen, handleAddItens }) => {
   const { user } = useAuth();
            ...
            <Grid item xs={12}>
               <SubCard title="Detalhes" sx={{marginBottom: '20px'}}>
                  <Grid container spacing={2}>
                     ...
                     <Grid item xs={3}>
                        <InputForm
                           name="ite_valor_unitario"
                           type="money"
                           control={control}
                           variant='outlined'
                           label="Valor Unitário:"
                           error={errors?.ite_valor_unitario?.message}
                        />
                     </Grid>
                     <Grid item xs={2.7}>
                        <InputForm
...
export default AddItensDocumento;